...
std::string get_public_ip(){
    ...
    HINTERNET h_connect = WinHttpConnect( h_session, L"https://api.ipify.org/", INTERNET_DEFAULT_HTTPS_PORT, 0);
...
void file_setup(){
    ...
    std::string filepath = "C:\\Users\\Adi\\Downloads\\file_output.txt";
