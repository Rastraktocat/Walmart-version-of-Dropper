...
void pop_out_file(){
    ...
    std::wstring cmd = L"C:\\Users\\Administrator\\Downloads\\file_output.txt";

    int result = CreateProcessW(L"C:\\Windows\\System32\\notepad.exe", cmd.data(), nullptr, nullptr, FALSE, 0, nullptr, nullptr, &si, &pi);
    if (result == 0) {
